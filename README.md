...
| **JavaScript** | Lógica completa del frontend |
| **OpenLibrary API** | Fuente de datos de libros |
| **localStorage** | Gestión de sesiones, usuarios y favoritos |
...
- ✅ **Móviles** (Mobile-first approach)

## 🚧 Pendientes / Mejoras Futuras

- [ ] Integración con API real de ratings
- [ ] Sistema de comentarios y reseñas por usuario
- [ ] Modo de lectura integrada (si OpenLibrary lo permite)
- [ ] Modo oscuro/claro intercambiable
- [ ] Filtros avanzados por autor, idioma o año
- [ ] Sistema de recomendaciones personalizadas
- [ ] Exportación de lista de favoritos

## 👨‍💻 Autor

**Diego Ginard**  
Proyecto educativo y demostrativo — Frontend Web Developer  
*(en construcción pero con toda la actitud 😎)*
